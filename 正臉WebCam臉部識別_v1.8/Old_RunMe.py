...
known_face_encodings = [
    james_face_encoding,
    banana_face_encoding,
    single_face_encoding,
    sister_face_encoding
]
known_face_names = [
    "James Li",
    "Banana Ding",
...
# 1.6.1 新增連續加入索引資料組的功能，呼叫自訂函式 addPerson，將新增資料組加入
while True:
    ...
    if(want_add == "n"):
        ...
        addPerson(known_face_encodings, known_face_names, file_name, person_name)
